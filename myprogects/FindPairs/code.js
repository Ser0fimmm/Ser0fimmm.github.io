...
(function(){
	...
	var Memory = {
		...
		buildHTML: function(){
			...
			this.$cards.each(function(k, v){
				...
				alt="'+ v.name +'" /></div>\
				<div class="back"><img src="https://avatars.mds.yandex.net/i?id=b3f6ab2cc6a752274564c63269c4af7df36f81dd-9067430-images-thumbs&n=13"\
				alt="Codepen" /></div></div>\
				</div>';
			});
	...
	var cards = [
        ...
        {
			name: "rails",
			img: "https://i.pinimg.com/736x/12/c0/5f/12c05f08d3ea1f424bb64d0e1125ea7f.jpg",
			id: 9
		},
